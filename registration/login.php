...
<div class="align">
	<form action="login.php" method="post">
		Username : <input id="user_name" type="text" name="user_name" value="<?php echo $user_name;?>" /><br/><br/>
		Password : <input id="password" type="password" name="password" value="" /><br/><br/>

		<div class="move"><input id = "submit" type="submit" name="submit" value="Log In" style="width:100px"><br/><br/>
		</div>
	</form>
</div>
